...
## Demo & Reference Samples

* **Original Performance**: [Herbie Hancock - Dolphin Dance (Piano Solo) on YouTube](https://www.youtube.com/watch?v=L3WXPd6_IuA)
* **Sample MIDI Output**: [dolphin_dance_human.mid](samples/dolphin_dance_human.mid)
* **Sample PDF Engraving**: [dolphin_dance_human.pdf](samples/dolphin_dance_human.pdf)

### Visual Score Previews
Below are screenshots of the typesetting outputs generated by this pipeline:

#### Clean Triplet Grouping (Measure 5)
![Measure 5 triplet layout](media/score_preview_1.png)

#### Independent Ottava Brackets & Hand Splits
![Treble/Bass split with ottava](media/score_preview_2.png)

#### Consolidating Hands for Melodic Clarity
![Staff consolidation](media/score_preview_3.png)
